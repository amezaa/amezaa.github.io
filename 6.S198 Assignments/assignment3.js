...
//   kernelSize: 3,
//   filters: 3,
//   inputShape: [image_shape[0]/2, image_shape[1]/2, image_shape[2]]
// }));
...
async function train() {
  ...
  for (let i = 0; i < NUM_BATCHES; i++) {
    ...
    //Gets accuracies of initial batches
    // if (i < NUM_BATCHES/5) {
    //   newStatistics.push(accuracy)
    // }
  ...
  //Problem 6 of assignment
  var sum = accuracyValues.reduce(function(a, b) { return a + b; }, 0);

  window.alert(sum/(length(accuracyValues)));
  //--------------------------------
}
